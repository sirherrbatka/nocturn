...
# Generated by qmake (2.01a) (Qt 4.8.5) on: ?r. lis 27 11:02:28 2013
# Project:  nocturn.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/nocturn1.0.0/ && $(COPY_FILE) --parents audiotrackmodel.h maincontroler.h mainview.h modelmanager.h nocturn.h playbackmanager.h playbackmodel.h playbackphonon.h playlistmanager.h playlistmodel.h playlistpageview.h playlistpageviewitem.h sharedtypes.h taghandler.h .tmp/nocturn1.0.0/ && $(COPY_FILE) --parents audiotrackmodel.cpp main.cpp maincontroler.cpp mainview.cpp modelmanager.cpp nocturn.cpp playbackmanager.cpp playbackmodel.cpp playbackphonon.cpp playlistmanager.cpp playlistmodel.cpp playlistpageview.cpp playlistpageviewitem.cpp taghandler.cpp .tmp/nocturn1.0.0/ && $(COPY_FILE) --parents mainform.ui .tmp/nocturn1.0.0/ && (cd `dirname .tmp/nocturn1.0.0` && $(TAR) nocturn1.0.0.tar nocturn1.0.0 && $(COMPRESS) nocturn1.0.0.tar) && $(MOVE) `dirname .tmp/nocturn1.0.0`/nocturn1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/nocturn1.0.0
...
compiler_moc_header_make_all: moc_maincontroler.cpp moc_mainview.cpp moc_nocturn.cpp moc_playbackmanager.cpp moc_playbackmodel.cpp moc_playbackphonon.cpp moc_playlistmodel.cpp moc_playlistpageview.cpp moc_playlistpageviewitem.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_maincontroler.cpp moc_mainview.cpp moc_nocturn.cpp moc_playbackmanager.cpp moc_playbackmodel.cpp moc_playbackphonon.cpp moc_playlistmodel.cpp moc_playlistpageview.cpp moc_playlistpageviewitem.cpp
...
moc_playlistpageviewitem.cpp: playlistpageviewitem.h
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) playlistpageviewitem.h -o moc_playlistpageviewitem.cpp
...
playlistpageviewitem.o: playlistpageviewitem.cpp playlistpageviewitem.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o playlistpageviewitem.o playlistpageviewitem.cpp
...
moc_playlistpageviewitem.o: moc_playlistpageviewitem.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_playlistpageviewitem.o moc_playlistpageviewitem.cpp
