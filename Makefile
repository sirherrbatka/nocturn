...
# Generated by qmake (2.01a) (Qt 4.8.5) on: pon. lis 25 14:00:27 2013
# Project:  nocturn.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/nocturn1.0.0/ && $(COPY_FILE) --parents audiotrackmodel.h maincontroler.h mainview.h modelmanager.h playbackmanager.h playbackmodel.h playbackphonon.h playlistmanager.h playlistmodel.h playlistpageview.h sharedtypes.h taghandler.h .tmp/nocturn1.0.0/ && $(COPY_FILE) --parents audiotrackmodel.cpp main.cpp maincontroler.cpp mainview.cpp modelmanager.cpp playbackmanager.cpp playbackmodel.cpp playbackphonon.cpp playlistmanager.cpp playlistmodel.cpp playlistpageview.cpp taghandler.cpp .tmp/nocturn1.0.0/ && $(COPY_FILE) --parents mainform.ui .tmp/nocturn1.0.0/ && (cd `dirname .tmp/nocturn1.0.0` && $(TAR) nocturn1.0.0.tar nocturn1.0.0 && $(COMPRESS) nocturn1.0.0.tar) && $(MOVE) `dirname .tmp/nocturn1.0.0`/nocturn1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/nocturn1.0.0
