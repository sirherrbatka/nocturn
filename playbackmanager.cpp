...
PlaybackModel* PlaybackManager::getPlaybackModel() const
{
    return mPlaybackModel.get();
}
...
{
  MainControler::getMainControler()->fileEnded();
}

void PlaybackManager::togglePlayback()
{
