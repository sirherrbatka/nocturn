...
static const char qt_meta_stringdata_PlaybackManager[] = {
    "PlaybackManager\0\0,\0"
...
void PlaybackManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->fileEnded(); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData PlaybackManager::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PlaybackManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PlaybackManager,
      qt_meta_data_PlaybackManager, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PlaybackManager::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PlaybackManager))
...
// SIGNAL 0
void PlaybackManager::StatusChanged(SharedTypes::PlaybackState _t1, SharedTypes::PlaybackState _t2)
{
